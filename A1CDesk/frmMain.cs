...
namespace A1CDesk
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void Btn_AddUpdate_Click(object sender, EventArgs e)
        {
            ...
            //cmd.CommandText = sSQL; // "insert into Items ([Item_Name],[Item_Price]) values ('" + itemNameTBox.Text + "','" + Convert.ToDouble(itemPriceTBox.Text) + "')";
            //cmd.CommandText = "Insert into dbo_tbl_A1C ([userID], [Reading_Date], [Reading_TOD], [Reading_Value], [Comments]) values (?,?,?,?,?)";
            //cmd.Parameters.AddWithValue("@userID", "MCWILEY");
            //cmd.Parameters.AddWithValue("@RDate", mydate.ToString("yyyy/MM/dd"));
            //cmd.Parameters.AddWithValue("@RTOD", "1");
            //cmd.Parameters.AddWithValue("@RVal", Entry_Value.Value);
            //cmd.Parameters.AddWithValue("@RComment", "None");
